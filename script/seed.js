...
async function seed() {
  ...
  const products = await Promise.all([
    ...
    Product.create({category: 'meat', name: 'Pepperoni', description: 'A vibrantly spiced, air-dried, cured Italian sausage, pepperoni (or peperone in Italian) is long and thin compared to other salamis.', price: 40, stock: 20, imageURL: 'http://thegreyplume.com/wp-content/uploads/2014/11/pepperoni-1-pound-charcuterie-grey-plume-omaha-edited.jpg'}),
    Product.create({category: 'extra', name: 'Baguettes', description: 'A delicious crunchy, long, and thin loaf of French bread that is commonly made from basic lean dough distinct for its length.', price: 55, stock: 25, imageURL: 'https://cdn.shopify.com/s/files/1/0307/2417/products/Baguette-rounds_600x.jpg'}),
    ...
    Product.create({category: 'charcuterie board', name: 'Charcuterie Board', description: 'Pre-packaged charcuterie board to wow your guests for under $100!', price: 39, stock: 1, imageURL: 'https://cdn.shopify.com/s/files/1/1115/5612/products/REY273LN2-Large-Round-Beech-Pizza-Board-1.jpg'})
  ])
